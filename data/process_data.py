...
def clean_data(df):
    ...
    Input: Loads df dataset which is a merge of messages and categories
...
def save_data(df, database_filename):
    ...
    """
     ...
     df.to_sql('Disaster_Response_Table', con=engine, index=False, if_exists='replace')
